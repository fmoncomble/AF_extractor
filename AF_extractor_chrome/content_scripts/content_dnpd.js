...
if (test) {
  ...
  anchor = document.querySelector(".block.block-academie");
...
let lastPageButton = document.querySelector(".pager-last a");
if (lastPageButton) {
  extractButton.before(checkboxDiv);
  const lastPageUrl = lastPageButton.getAttribute("href");
